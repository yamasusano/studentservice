...
add_action('admin_menu', 'manage_major_plugin_menu');
 ...
 function get_admin_major_list()
 {
     ...
     $HTML .= '<button class="btn btn-md page-title-action">Add new</button>';
...
function admin_major_list()
{
    ...
    $HTML .= '<tr>';
    $HTML .= '<th>Code</th> <th>Name</th>  <th>Icon</th> <th><span class="vers comment-grey-bubble"></span></th> <th>Date modified</th><th>Action</th>';
    $HTML .= '</tr>';
    $majors = query_major();
