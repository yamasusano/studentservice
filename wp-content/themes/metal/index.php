...
if( zozo_get_theme_option( 'zozo_blog_type' ) == 'grid' ) {	
	if( zozo_get_theme_option( 'zozo_blog_grid_columns' ) != '' ) {
		if( zozo_get_theme_option( 'zozo_blog_grid_columns' ) == 'two' ) {
			$container_class = 'grid-layout grid-col-2';
		} elseif( zozo_get_theme_option( 'zozo_blog_grid_columns' ) == 'three' ) {
			$container_class = 'grid-layout grid-col-3';
		} elseif( zozo_get_theme_option( 'zozo_blog_grid_columns' ) == 'four' ) {
...
} elseif( zozo_get_theme_option( 'zozo_blog_type' ) == 'large' ) {
...
} elseif( zozo_get_theme_option( 'zozo_blog_type' ) == 'list' ) {
			...
			<div class="zozo-row row">
				<div id="primary" class="content-area <?php zozo_primary_content_classes(); ?>">
					<div id="content" class="site-content">	
						...
						if( zozo_get_theme_option( 'zozo_show_blog_featured_slider' ) == 1 && zozo_get_theme_option( 'zozo_featured_slider_type' ) == 'above_content' ) {
