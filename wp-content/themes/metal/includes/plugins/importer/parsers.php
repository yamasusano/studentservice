...
class WP_FileSystem_Credentials {
	static function check_credentials() {
		...
		$demo_import_page_url = wp_nonce_url( 'admin.php?page=metal-demos', 'metal-demos' );
		if ( false === ( $creds = request_filesystem_credentials( $demo_import_page_url, '', false, false, null ) ) ) {
			return new WP_Error( 'XML_parse_error', esc_html__( 'There was an error when reading this WXR file', 'wordpress-importer' ) );
		}
...
class WXR_Parser_SimpleXML {
	function parse( $file ) {
		...
		$url      = "http://themes.zozothemes.com/extras/importer/metal/" . $file;
